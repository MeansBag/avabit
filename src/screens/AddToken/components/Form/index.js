  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <View style={styles.formElement}>
          <Text style={styles.formLabel}>{I18n.t('token_name')}</Text>
          <View style={styles.formInputRow}>
            <TextInput
              autoCorrect={false}
        ...
        <View style={styles.formElement}>
          <Text style={styles.formLabel}>{I18n.t('token_symbol')}</Text>
          <View style={styles.formInputRow}>
            <TextInput
              autoCorrect={false}
        ...
        <View style={styles.formElement}>
          <Text style={styles.formLabel}>{I18n.t('token_decimals')}</Text>
          <View style={styles.formInputRow}>
            <TextInput
              autoCorrect={false}
